...
\label{sec:orgf28cb85}
\label{orga029a07}

Figure \ref{fig:org4208eda} show the mean time for execution of the medium
...
\begin{figure}[!htb]
\centering
\includegraphics[width=1\textwidth]{/tmp/babel-CGIwRH/figureN1yGo1.pdf}
\caption{\label{fig:org4208eda}Mean of time results.}
\end{figure}


WAIT FOR FINAL DATA TOMORROW\ldots{}
Maybe rerun with large scale experiments now that I have more time?

\section{Conclusion}
\label{sec:orgad29d48}
\label{org4bd76b3}
